...
function Footer() {
    return (
        <div>
            <footer class=" w-full text-white py-8 bg-gradient-to-t from-teal-500 to-teal-200">

                <div class="container mx-auto flex flex-wrap justify-between">
                    <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/6 px-4 mb-4">
                        <h2 class="text-xl font-bold mb-4 text-teal-950">À propos</h2>
                        <ul>
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/6 px-4 mb-4">
                        <h2 class="text-xl font-bold mb-4 text-teal-950">Services</h2>
                        <ul>
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/6 px-4 mb-4">
                        <h2 class="text-xl font-bold mb-4 text-teal-950">Contact</h2>
                        <ul>
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/6 px-4 mb-4">
                        <h2 class="text-xl font-bold mb-4 text-teal-950">Réseaux sociaux</h2>
                        <ul>
